...
public class DistrictDataListAdapter  extends ArrayAdapter<DistrictWeb> {
Context context;
	public DistrictDataListAdapter(Context context, int resource,
			List<DistrictWeb> colony) {
